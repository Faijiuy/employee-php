...
$sql = "
        SELECT * FROM (employees e left join dept_emp de on e.emp_no = de.emp_no) join departments d on de.dept_no = d.dept_no ORDER BY de.to_date DESC
        limit 10;
        ";
$result = mysqli_query($conn, $sql);
...
?>
    <table>
        <thead>
            <th class="box">Employee ID</th>
            <th class="box">First Name</th>
            <th class="box">Last Name</th>
            <th class="box">Department</th>
            <th class="box">Birth Date</th>
            <th class="box">Hire Date</th>
            <th class="box">Gender</th>
            <th class="box">Delete</th>
            <th class="box">Update</th>
        </thead>
        <tbody>
            <?php
